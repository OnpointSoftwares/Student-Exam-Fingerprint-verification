...
import com.example.fingerprintstudentverification.databinding.ActivityAddStudentsBinding
...
class AddStudents : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_activity_add_students)
